...
T:F___main_org$__00010000[({0}S:S$base_address$0$0({2}SI:U),Z,0,0)({2}S:S$status$0$0({1}SC:U),Z,0,0)]
T:F___main_org$__00010001[({0}S:S$base_address$0$0({2}SI:U),Z,0,0)]
T:F___main_org$__gpio_instance_t[({0}S:S$base_addr$0$0({2}SI:U),Z,0,0)({2}S:S$apb_bus_width$0$0({1}SC:U),Z,0,0)]
...
S:Lmain$value$1$1({2}SI:U),F,0,0
S:Lmain$testvar$1$1({2}SI:U),F,0,0
S:Lmain$sram_addr$1$1({2}SI:U),F,0,0
S:Lmain$rx_data$2$4({2}DA2,SC:U),F,0,0
S:Lmain$rx_size$2$4({1}SC:U),F,0,0
...
S:G$display_brt_regs$0$0({2}DF,SV:S),C,0,0
S:G$read_user_input$0$0({2}DF,SV:S),C,0,0
S:G$get_key_selection$0$0({2}DF,SC:U),C,0,0
S:G$display_prompt$0$0({2}DF,SV:S),C,0,0
S:G$display_help$0$0({2}DF,SV:S),C,0,0
S:G$process_uart_data$0$0({2}DF,SV:S),C,0,0
S:G$display_mem_data$0$0({2}DF,SV:S),C,0,0
