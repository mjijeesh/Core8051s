...
# Tue Apr 27 14:50:02 2010

# (NEW DESIGN)

# create a new design
new_design -name "memory" -family "Fusion"

# set default back-annotation base-name
set_defvar "BA_NAME" "memory_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "memory.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VHDL" {../../synthesis/memory.edn}
...
compile
export -format "log" {C:\Actelprj\AFS_ADV_KIT_8051\synthesis\memory_drc_temp.rpt}
