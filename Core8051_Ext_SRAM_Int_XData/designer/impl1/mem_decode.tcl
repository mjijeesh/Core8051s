...
# Tue Apr 27 14:38:16 2010

# (NEW DESIGN)

# create a new design
new_design -name "mem_decode" -family "Fusion"

# set default back-annotation base-name
set_defvar "BA_NAME" "mem_decode_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "mem_decode.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VHDL" {../../synthesis/mem_decode.edn}
...
compile
export -format "log" {C:\Actelprj\AFS_ADV_KIT_8051\synthesis\mem_decode_drc_temp.rpt}
